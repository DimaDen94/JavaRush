...
public class Solution
{
    ...
    public static void cleanAllApartaments(List<Apartament> apartaments)
    {
        ...
        for (int i  = 0; i< apartaments.size(); i++){
            Apartament find = apartaments.get(i);
            if (find instanceof Apt1Room){
                ((Apt1Room) find).clean1Room();
            }
            else if (find instanceof Apt2Room)
            {
                ((Apt2Room) find).clean2Rooms();
            }
            else if (find instanceof Apt3Room)
            {
                ((Apt3Room) find).clean3Rooms();
            }
        }
    }
